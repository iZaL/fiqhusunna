                            ...
                            <tr class="gradeU">
                                ...
                                <td class="center">
                                    <p data-placement="top" data-toggle="tooltip" title="Delete">
                                        {!! Form::open(['action' => ['Admin\CategoryController@destroy', $category->id], 'method' => 'DELETE'], ['class'=>'form-horizontal']) !!}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            {!! Form::open(['action' => ['Admin\CategoryController@destroy', 1], 'method' => 'delete'],
